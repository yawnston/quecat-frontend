...
const elements_schema: ElementDefinition[] = [
    ...
    { data: { id: '12', label: 'Status' }, position: { x: 400, y: 0 } },
    { data: { id: '13', label: 'Quantity' }, position: { x: 500, y: 200 } },
    ...
    { data: { source: '14', target: '13', label: '13' } },
    { data: { source: '10', target: '14', label: '12' } },
